<?php
    ...
    check_session();
    $_SESSION["actual_page"] = "new_projector.php";
    $errores = "";
    $maxCar = 50;
    ...
    if(array_key_exists("saveProjector", $_POST))
    {
       ...
       $idOfficeConjunto = $_POST["id_office"];
        ...
        if (strlen($contrast)>50)
        {
            $errores.= "- El campo \"contraste\" no puede contener mas de 50 caracteres</br>";
        }
        if (strlen($bright)>50)
        {
            $errores.= "- El campo \"brillo\" no puede contener mas de 50 caracteres</br>";
        }

        $selectTypeEq= "select id_elect_eq_type from $tableElectEqType where name_elect_eq_type ='proyector';";
        ...
        if ($insertELEQ_ok)
        {
            ...
            $insertProj = "insert into $tableProjector ";
            $insertProj .= "(id_electronic_eq, trademark, model, type, bright, contrast) ";
            $insertProj .= "values (" . $idElectronic . ","
                                        . comillas($trademark) . ","   
                                        . comillas($model) . "," 
                                        . $typeProjector . "," 
                                        . comillas($bright) . "," 
			...
			<div id="page-bgbtm">
				...
				<div id="content">
                                    ...
                                    <div class="post">
                                        ...
                                        <fieldset>
                                            <legend><B>REGISTRO DE PROYECTOR</B></legend>
                                       <form action="" method="post" enctype="multipart/form-data">
                                            <table>
                                               <tr>
                                                   <td>Código URJC:</td>
                                                   <td><input type="text" size="50" name="urjc_code" value="<?php echo $codeUrjc;?>"/> </td>
                                                   <td><?php echo isFieldRequired("new_projector.php", "urjc_code"); ?></td>
                                               </tr>
                                               <tr>
                                                   <td>Número de Serie:</td>
                                                   <td><input type="text" size="50" name="serial_number" value="<?php echo $serialNumber;?>"/> </td>
                                                   <td><?php echo isFieldRequired("new_projector.php", "serial_number"); ?></td>
                                               </tr>
                                               <tr>
                                                   <td>Despacho</td>
                                                   <td><?php echo generateSelectOffice(); ?> </td>
                                                   <td><?php echo isFieldRequired("new_projector.php", "id_office"); ?></td>
                                               </tr>
                                                
                                               <tr>
                                                   <td>Imagen 1:</td>
                                                   <td><input name="image_1" type="file" size="50" /> </td>
                                                   <td><?php echo isFieldRequired("new_projector.php", "image_1"); ?></td>
                                               </tr>
                                               <tr>
                                                   <td>Imagen 2:</td>
                                                   <td><input name="image_2" type="file" size="50" /> </td>
                                                   <td><?php echo isFieldRequired("new_projector.php", "image_2"); ?></td>
                                               </tr>
                                               <tr>
                                                   <td>Estado:</td>
                                                   <td><?php echo generateSelectWithOptions("status", "status",
                                                           "id_status", "name_status"); ?> </td>
                                                   <td><?php echo isFieldRequired("new_projector.php", "status"); ?></td>
                                               </tr>
                                               <tr>
                                                   <td>Asignado a usuario:</td>
                                                   <td><?php echo generateSelectWithOptions("id_user_asigned", "user",
                                                           "id_user", "email"); ?> </td>
                                                   <td><?php echo isFieldRequired("new_projector.php", "id_user_asigned"); ?></td>
                                               </tr>
                                                
                                              <tr>
                                                  <td>Marca:</td>
                                                  <td><input type="text" size="50" name="trademark" value="<?php echo $trademark;?>"/> </td>
                                                  <td><?php echo isFieldRequired("new_projector.php", "trademark"); ?></td>
                                               </tr>
                                               <tr>
                                                   <td>Modelo:</td>
                                                   <td><input type="text" size="50" name="model" value="<?php echo $model;?>"/></td>
                                                   <td><?php echo isFieldRequired("new_projector.php", "model"); ?></td>
                                               </tr>
                                               <tr>
                                                   <td>Tipo:</td>
                                                   <td><?php echo generateSelectWithOptions("type_projector", "projector_type",
                                                           "id_type_projector", "name_projector"); ?></td>
                                                   <td><?php echo isFieldRequired("new_projector.php", "type_projector"); ?></td>
                                               </tr>
                                               <tr>
                                                   <td>Brillo:</td>
                                                   <td><input type="text" size="50" name="bright" value="<?php echo $bright;?>"/></td>
                                                   <td><?php echo isFieldRequired("new_projector.php", "bright"); ?></td>
                                               </tr>
                                               <tr>
                                                   <td>Contraste:</td>
                                                   <td><input type="text" size="50" name="contrast" value="<?php echo $contrast;?>"/></td>
                                                   <td><?php echo isFieldRequired("new_projector.php", "contrast"); ?></td>
                                               </tr>
                                                <tr>
                                                   <td>Comentarios:</td>

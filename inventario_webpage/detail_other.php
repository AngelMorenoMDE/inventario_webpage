<?php
    ...
    check_session();
    $_SESSION["actual_page"] = "detail_other.php";  
    $errores = "";
    ...
    if(array_key_exists("idElectronic", $_SESSION)) 
    {
        ...
        $selectOther = "select * from others where id_electronic_eq=" . $idwire . ";"  ; 
 
        $rowEquipment = select_one($selectElectEq);
        $rowOther = select_one($selectOther);
				...
				<div id="content">
                                    ...
                                    <div class="post">
                                            ...
                                            <form action="" method="post">
                                                <table class ="border">
                                                    <caption>DETELLES DEL EQUIPO</caption>
                                                    <tr class ="border">
                                                    ...
                                                    <tr class ="border">
                                                        <td class ="tdBack">Nombre: </td><td class ="border"><?php echo $nameO?></td>
                                                    </tr>

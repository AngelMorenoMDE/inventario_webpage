...
require_once "ini.php";
    check_session();  
    $_SESSION["actual_page"] = "detail_printer.php"; 
    $color_checked="";
    $laser_checked="";
    $paralel_checked="";
    $usb_checked="";
    ...
    if(array_key_exists("idElectronic", $_SESSION)) 
    {
        ...
        $selectElectEq = "select * from $tableElectEq where id_electronic_eq =" . $idElectronic . ";" ;
        ...
        if($rowPrinter['color'])
        {
            $color_checked = $pathIcon . "si.png";
        }
        else 
        {
            $color_checked = $pathIcon . "no.png" ; 
        }

        if($rowPrinter['laser'])
        {
            $laser_checked = $pathIcon . "si.png";
        }
        else 
        {
            $laser_checked = $pathIcon . "no.png" ; 
        }

        if($rowPrinter['paralel'])
        {
            $paralel_checked = $pathIcon . "si.png";
        }
        else 
        {
            $paralel_checked = $pathIcon . "no.png" ; 
        }

        if($rowPrinter['usb'])
        {
            $usb_checked = $pathIcon . "si.png";
        }
        else 
        {
            $usb_checked = $pathIcon . "no.png" ; 
        }

        if($rowPrinter['ethernet'])
        {
            $ether_checked = $pathIcon . "si.png";
        }
        else 
        {
            $ether_checked = $pathIcon . "no.png" ; 
        }
			...
			<div id="page-bgbtm">
				...
				<div id="content">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <table class ="border">
                                            <caption>DETALLES DE LA IMPRESORA</caption>
                                            <tr class ="border">
                                            ...
                                            <tr class ="border">
                                                <td class ="tdBack">Imagen 2</td><td><img src ="<?php echo $pathImage2;?>" width="100 "height="100"></td>
                                            </tr>
                                            <tr class ="border">
                                            ...
                                            <tr class ="border">
                                                <td class ="tdBack">Color</td><td class ="border"><img src ="<?php echo $color_checked;?>"></td>
                                            </tr>
                                            <tr class ="border">
                                                <td class ="tdBack">Puerto paralelo</td><td class ="border"><img src ="<?php echo $paralel_checked;?>"></td>
                                            </tr>
                                            <tr class ="border">
                                                <td class ="tdBack">Puerto USB</td><td class ="border"><img src ="<?php echo $usb_checked;?>"></td>
                                            </tr>
                                            <tr class ="border">
                                                <td class ="tdBack">Puerto Ethernet</td><td class ="border"><img src ="<?php echo $ether_checked;?>"></td>
                                            </tr>
                                            <tr class ="border">

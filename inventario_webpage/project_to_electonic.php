<?php
    ...
    check_session();
    $errores ="";
     $_SESSION["actual_page"] = "project_to_electronic.php";
    $msg=null;
    $idProject = $_SESSION["idProject"];
    

   
    if(array_key_exists("saveEq", $_POST))
    {
       if(!array_key_exists("id_electronic", $_POST))
       {
        ...
        else 
        {
           ...
           {
               $sel= "insert into project_eq values (" .$idProject . "," . $valor . ");";
               execute_query($sel);
           }
    ...
    $sel = "select id_electronic_eq, electronic_eq_type, urjc_code, "
            ...
            . "and id_electronic_eq not in (select id_electronic_eq from project_eq "
    ...
    if (mysql_num_rows($result)>0)
    {
        ...
        $resultSearchHTML .= "<th class=\"border\">Seleccionar</th><th class=\"border\">Tipo de equipo</th><th class=\"border\">Características</th>";
        $resultSearchHTML .= "<th class=\"border\">Código URJC</th><th class=\"border\">Número de serie</th>";
        $resultSearchHTML .= "<th class=\"border\">Despacho</th><th class=\"border\">Usuario Asignado</th>";
                ...
                else
                {
                    ...
                    if($c == 5)
                    {
                       $nameUser = GetNameOption($valor, "user", "id_user", "name");
                            $resultSearchHTML .= "<td class=\"border\">$nameUser</td>";
                    }
                                    ...
                                    <div class="post">
                                        ...
                                        <form action="" method="post">
                                            <table>
                                                <tr>
                                                    <td>
                                                        <p><b> Seleccione los Equipos a asociar al Proyecto y pulse Guardar:</b></p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <input type="submit" class="normalButton" name="saveEq" value="Guardar"></input>
                                                    </td>
                                                </tr>

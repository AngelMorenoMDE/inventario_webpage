...
header('Content-Type: text/html; charset=UTF-8');
    ...
    check_session();
    $_SESSION["actual_page"] = "edit_purchase.php";  
    $errores = "";
    $maxCar = 50;
...
if(array_key_exists("idPurchase", $_SESSION)) 
    {
        ...
        $idProject = $rowPurchase["id_project"];
        $price = $rowPurchase["price"];
        $name_purchase = $rowPurchase["name_purchase"];
        $date_purchase = $rowPurchase["date_purchase"];
        $date_purchase = date("d-m-Y", $date_purchase);
        $purchaser= $rowPurchase["purchaser"];
        
    } 
    else
    {
        redirect("list_pruchase.php");
    }

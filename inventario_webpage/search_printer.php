<?php
    ...
    check_session();
    $_SESSION["actual_page"] = "search_printer.php"; 
    ...
    $sel = "select e.id_electronic_eq, e.urjc_code, e.status, "
            . " p.color, p.laser, p.paralel, p.usb, p.ethernet, p.name_equip, p.ip"
            . " from electronic_equipment e, printer p  where "
            . "e.id_electronic_eq = p.id_electronic_eq;" ;
    ...
    if (mysql_num_rows($selectEq)>0)
    {
        if(is_admin(getUserRolInSession()))
        {
            ...
            $resultSearchHTML .= "<th class=\"border\">Color</th><th class=\"border\">Laser</th>";
            $resultSearchHTML .= "<th class=\"border\">Usb</th><th class=\"border\">Paralelo</th><th class=\"border\">Ethernet</th>";
                           ...
                           foreach ($line as $valor) 
                           {
                               ...
                               if ($c == 3)
                               {
                                   if ($valor == 1) 
                                    ...
                                    $resultSearchHTML .= "<td class=\"border\">$color</td>";
                               }
                               if ($c == 4)
                               {
                                   if ($valor == 1) 
                                    ...
                                    $resultSearchHTML .= "<td class=\"border\">$laser</td>";
                               }
                               if ($c == 5)
                               {
                                   if ($valor == 1) 
                                    ...
                                    $resultSearchHTML .= "<td class=\"border\">$usb</td>";
                               }
                               ...
                               if ($c == 6)
                               {
                                   if ($valor == 1) 
                                    ...
                                    $resultSearchHTML .= "<td class=\"border\">$paralel</td>";
                               }
                               if ($c == 7)
                               {
                                   if ($valor == 1) 
                                    ...
                                    $resultSearchHTML .= "<td class=\"border\">$ether</td>";
                               }
                               if (($c != 0) && ($c != 2)&& ($c != 3)&& ($c != 4)&& ($c != 5)&& ($c != 6) && ($c != 7))
                                {
   ...
   if(array_key_exists("search", $_POST))//recogemos los datos nuevos    
    {
        ...
        if (!empty($name_equip))
        {
            if ($control == true)
            {
                ...
                $where .= " or (p.name_equip = ". comillas($name_equip) . ")" ;

            }
            else 
            {
                 $where .= "(p.name_equip = ". comillas($name_equip) . ")" ; 
                 $control = true;
            }    
        }
        ...
        if (!empty($ip))
        {
            ...
            if ($control == true)
            {
                ...
                $where .= " or (p.ip = ". comillas($ip) . ")" ;

            }
            else 
            {
                 $where .= "(p.ip = ". comillas($ip) . ")" ; 
                 $control = true;
            }
        }
        ...
        if ($errores == "")
        {
                ...
                $sel = "select e.id_electronic_eq, e.urjc_code, e.status, "
                        . " p.color, p.laser, p.paralel, p.usb, p.ethernet, p.name_equip, p.ip"
                        . " from electronic_equipment e, printer p  where "
                        . "e.id_electronic_eq = p.id_electronic_eq and (" . $where . ");" ;

<?php
    ...
    check_session();
    $_SESSION["actual_page"] = "detail_keyboard.php";
    $errores = "";
    $wireless_checked="";
    ...
    if(array_key_exists("idElectronic", $_SESSION)) 
    {
        ...
        $selectWire = "select * from $tableWireType where id_wire_type=" . $conector .";";
        $rowWire = select_one($selectWire);
        $nameWire = $rowWire['name_wire_type'];
				...
				<div id="content">
                                    ...
                                    <div class="post">
                                            ...
                                            <form action="" method="post">
                                                <table class ="border">
                                                    <caption>DETALLES DEL TECLADO</caption>
                                                    <tr class ="border">
                                                    ...
                                                    <tr class ="border">
                                                        <td class ="tdBack">Inalámbrico: </td><td class ="border"><img src ="<?php echo $pathImage3;?>"/></td>
                                                    </tr>
                                                    <tr class ="border">

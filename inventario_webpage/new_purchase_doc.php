<?php
    ...
    check_session();
    $_SESSION["actual_page"] = "new_purchase_doc.php";
    ...
    if(array_key_exists("idPurchase", $_SESSION)) 
    {
        ...
        {     
            ...
            $insertDocument = "insert into $tablePurchaseDoc (id_purchase, name, name_description,";
            $insertDocument .= " mimetype, size, extension, date_upload, user_upload) ";
            $insertDocument .= "values ("  . $idPurchase . ",". comillas($document_name) . "," 
                                        . comillas($nombreDes). "," 
                                        . comillas($type) . ","
                                        . $tamano . ","   
                                        . comillas($extension) . ","
			...
			<div id="page-bgbtm">
				...
				<div id="content">
                                    ...
                                    <div class="post">
                                        ...
                                        <fieldset>
                                            <legend><B>SUBIDA DE DOCUMENTOS DE COMPRA</B></legend>

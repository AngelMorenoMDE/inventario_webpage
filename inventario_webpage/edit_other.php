<?php
    ...
    $_SESSION["actual_page"] = "edit_other.php";
    $description = "";
    ...
    if(array_key_exists("idElectronic", $_SESSION)) 
    {
        ...
        echo "[IDElectronic]".$idElectronic."<br>";
        $selectEq = "select * from $tableElectEq where id_electronic_eq =" . $idElectronic . ";" ;
        $selectWire = "select * from others where id_electronic_eq=" . $idElectronic . ";"  ;  

        $rowElectronic= select_one($selectEq);   
        $rowOther= select_one($selectWire);
    ...
    if(array_key_exists("saveOther", $_POST))
    {
        ...
        $editOther= "update others set name =" . comillas($name) ."where id_electronic_eq =" 
                . $idElectronic. ";";      
        ...
        {   
            ...
            if ((execute_query($editEq)) && (execute_query($editOther)))//comprobamos que la query se hizo correcta
            {
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo isFieldRequired("edit_other.php", "image_2"); ?></td>

<?php
    ...
    check_session();
    $_SESSION["actual_page"] = "detail_mouse.php";
    $errores = "";
    ...
    if(array_key_exists("idElectronic", $_SESSION)) 
    {
       ...
       $conexion =  new_conex_db();
        ...
        $nameWire = GetNameOption($rowMouse['conector_type'], "wire_type", "id_wire_type", "name_wire_type");
        ...
        if($rowMouse['optik'])
        {
            $pathImage4 = getIconPath() . "si.png";
        }
        else
        {
            $pathImage4 = getIconPath() . "no.png";
        }
				...
				<div id="content">
                                    ...
                                    <div class="post">
                                            ...
                                            <form action="" method="post">
                                                <table class ="border">
                                                    <caption>DETALLES DEL RATON</caption>
                                                    <tr class ="border">
                                                    ...
                                                    <tr class ="border">
                                                        <td class ="tdBack">Óptico: </td><td class ="border"><img src ="<?php echo $pathImage4;?>"/></td>
                                                    </tr>
                                                    <tr class ="border">

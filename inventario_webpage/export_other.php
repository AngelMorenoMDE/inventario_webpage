...
<title>::. Exportación de datos de cables .::</title>
    ...
    <?php
        ...
        $sel .=  " o.name from electronic_equipment as e inner join others as o ";
        $sel .=  " on e.id_electronic_eq = o.id_electronic_eq;";
    ...
    ?>
       ...
       <table border=1 align="center" cellpadding=1 cellspacing=1>
           <tr>LISTADO DE EQUIPOS ELECTRONICOS VARIOS</tr>
           <tr>
           <td>CODIGO URJC</td>
               ...
               while($row = mysql_fetch_array($result)) 
                {
                   ...
                   $office = GetNameOption($row["id_office"], "office", "id_office", "name_office");
                    ...
                    </tr>", $row["urjc_code"],$row["serial_number"],$office, $status, $user, $row["name"]);
               }

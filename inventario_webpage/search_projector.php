...
check_session();
$_SESSION["actual_page"] = "search_projector.php";
...
$sel = "select e.id_electronic_eq, e.urjc_code, e.serial_number, "
        . "e.status, p.type, p.bright, "
        . "p.contrast from electronic_equipment e, projector p  where "
...
if (mysql_num_rows($selectEq)>0)
{
    if(is_admin(getUserRolInSession()))
    {
        ...
        $resultSearchHTML .= "<th class=\"border\">Tipo de Proyector</th>";
        $resultSearchHTML .= "<th class=\"border\">Brillo</th><th class=\"border\">Contraste</th>";
    ...
    while ($line = mysql_fetch_assoc($selectEq)) 
    {
        ...
        foreach ($line as $valor) 
        {
            ...
            if ($c == 4)
            {
                $projector_type = GetNameOption($valor, 
                        "projector_type", "id_type_projector", "name_projector");
                $resultSearchHTML .= "<td class=\"border\">$projector_type</td>";
            }
            if (($c != 0) && ($c != 3) &&  ($c != 4))
            {
                                                    ...
                                                    <table>
                                                        ...
                                                        <tr>
                                                         ...
                                                         <tr>
                                                             ...
                                                             <td>Tipo Proyector: </td>
                                                             <td><?php echo generateSelectWithOptionsSearch("projector", "projector_type",

<?php
    ...
    check_session();  
    $_SESSION["actual_page"] = "detail_monitor.php";
    $vga_checked="";
    $dvi_checked="";
    $conector = "";
    ...
    if(array_key_exists("idElectronic", $_SESSION)) 
    {
        ...
        $select1 = "select * from $tableElectEq where id_electronic_eq =" .  $idElectronic . ";" ;
        $select2 = "select * from $tableMonitor where id_electronic_eq=" .  $idElectronic . ";"  ; 

        $rowEquipment = select_one($select1);
        $rowMonitor = select_one($select2);
        ...
        $selectBuilding = "select name_building from $tableBuilding where id_building in 
                            ( select id_building from $tableOffice where id_office = $idOffice);";
        ...
        $dateCreation = $rowEquipment['date_creation'];
        $dateModify = $rowEquipment['date_modify'];
        $dateDelete = $rowEquipment['date_delete'];
        if($rowEquipment['date_delete'] == -1)
        {
            $dateDelete = "Equipo no descatalogado"; 
        }
        else
        {
            $date_Delete = $rowEquipment['date_delete'];
            $dateDelete = date('d/m/Y',$date_Delete);
        }
        ...
        $nameMonitor = GetNameOption($rowMonitor['monitor_type'], "monitor_type", "id_monitor_type", "name_monitor_type");
        $vga = $rowMonitor['vga'];
        $dvi = $rowMonitor['dvi'];
        ...
        if ($vga_checked == 1)
        {
            $pathImage3 = getIconPath() . "si.png";
        }
        if ($vga_checked == 0)
        {
            $pathImage3 = getIconPath() . "no.png";
        }
        if ($dvi_checked == 1)
        {
            $pathImage3 = getIconPath() . "si.png";
			...
			<div id="page-bgbtm">
				...
				<div id="content">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <table class ="border">
                                            <caption>DETALLES DEL MONITOR</caption>
                                            <tr class ="border">
                                            ...
                                            <tr class ="border">
                                                <td class ="tdBack">Fecha de creación </td><td class ="border"><?php echo date('d/m/Y', $dateCreation) ;?></td>
                                            </tr>
                                            <tr class ="border">
                                                <td class ="tdBack">Fecha de modificación</td><td class ="border"><?php echo date('d/m/Y', $dateModify) ;?></td>
                                            </tr>
                                            <tr class ="border">
                                                <td class ="tdBack">Fecha de borrado</td><td class ="border"><?php echo $dateDelete ;?></td>
                                            </tr>
                                            <tr class ="border">
                                            ...
                                            <tr class ="border">
                                                <td class ="tdBack">Número de pulgadas</td><td class ="border"><?php echo $no_inch;?></td>
                                            </tr>
                                            <tr class ="border">
                                                <td class ="tdBack">Tipo de monitor</td><td class ="border"><?php echo $nameMonitor;?></td>
                                            </tr>
                                            <tr class ="border">
                                                <td class ="tdBack">VGA: </td><td class ="border"><img src ="<?php echo $pathImage3;?>"/></td>
                                            </tr>
                                            <tr class ="border">
                                                <td class ="tdBack">DVI: </td><td class ="border"><img src ="<?php echo $pathImage3;?>"/></td>
                                            </tr>
                                            <tr class ="border">

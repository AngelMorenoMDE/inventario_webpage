<?php
    ...
    check_session();
    $_SESSION["actual_page"] = "edit_keyboard.php";  
    $errores = "";
    $maxCar = 50;
    ...
    if(array_key_exists("idElectronic", $_SESSION)) 
    {
        ...
        $selectKeyboard = "select * from $tableKeyboard where id_electronic_eq=" . $idElectronic . ";"  ; 

        $rowElectronic = select_one($selecteq);
        $rowKeyboard = select_one($selectKeyboard);
        ...
        $trademark = $rowKeyboard['trademark'];
        $model = $rowKeyboard['model'];
        $conector = $rowKeyboard['conector_type'];
        $wireless = $rowKeyboard['wireless'];

      
        
        if($rowKeyboard['wireless'])
        {
    ...
    {   
        ...
        $editMonitor="update $tableKeyboard set trademark = " . comillas($trademark). 
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo isFieldRequired("edit_keyboard.php", "conector"); ?></td>
                                            </tr>
                                            <tr>

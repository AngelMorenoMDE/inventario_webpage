<?php
    ...
    check_session();
    $_SESSION["actual_page"] = "new_keyboard.php";
    $errores = "";
    $maxCar = 50;
    ...
    if(array_key_exists("saveKeyboard", $_POST))
    {
        ...
        $selectTypeEq= "select id_elect_eq_type from $tableElectEqType where name_elect_eq_type ='teclado';";
        ...
        $insertEquip .= "id_office, id_project, image_1, image_2, status, id_user_asigned, id_user_creation, id_user_modify,";
        ...
        $insertEquip .= "(" .$idElectronicEqType . "," . $codeUrjc .
                            "," . comillas($serialNumber) . "," . $idOffice . "," . $idProject .
        ...
        if ($insertELEQ_ok)
        {
            ...
            $inserKeyboard = "insert into $tableKeyboard ";
            $inserKeyboard .= "(id_electronic_eq, trademark, model, conector_type, wireless) ";
            $inserKeyboard .= "values (" . $idElectronic . "," . comillas($trademark) . ","   
                                        . comillas($model) . "," . comillas($conector) . ","    
                                        . $wireless . ");"; 
            
            
            $insertProject_ok = false;
            if ($errores == "")
            {   
                ...
                if (execute_query($inserKeyboard))
                {
                    $insertProject_ok = true;
                }
                else
                {
                    die("Error de inserción");
            ...
            if ($insertProject_ok)
            {
                ...
                $idProject = $rowEq['id_project'];
                               

                $insertProjectEq = "insert into $tableProjectEq (id_project, id_electronic_eq) values($idProject, $idElectronic);";

                if ($errores == "")
                {   

                    if (execute_query($insertProjectEq))
                    {
			...
			<div id="page-bgbtm">
				...
				<div id="content">
                                    ...
                                    <div class="post">
                                         ...
                                         <fieldset>
                                             <legend><B>REGISTRO DE TECLADO</B></legend>
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <table>
                                                <tr>
                                                    <td>Código URJC:</td>
                                                    <td><input type="text" size="50" name="urjc_code" value="<?php echo $codeUrjc;?>"/> </td>
                                                    <td><?php echo isFieldRequired("new_keyboard.php", "urjc_code"); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Número de Serie:</td>
                                                    <td><input type="text" size="50" name="serial_number" value="<?php echo $serialNumber;?>"/> </td>
                                                    <td><?php echo isFieldRequired("new_keyboard.php", "serial_number"); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Despacho:</td>
                                                    <td><?php echo generateSelectOffice(); ?> </td>
                                                    <td><?php echo isFieldRequired("new_keyboard.php", "id_office"); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Proyecto:</td>
                                                    <td><?php echo generateSelectWithOptions("id_project", "project",
                                                            "id_project", "name_project"); ?> </td>
                                                    <td><?php echo isFieldRequired("new_keyboard.php", "id_project"); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Imagen 1:</td>
                                                    <td><input name="image_1" type="file" size="50" /> </td>
                                                    <td><?php echo isFieldRequired("new_keyboard.php", "image_1"); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Imagen 2:</td>
                                                    <td><input name="image_2" type="file" size="50" /> </td>
                                                    <td><?php echo isFieldRequired("new_keyboard.php", "image_2"); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Estado:</td>
                                                    <td><?php echo generateSelectWithOptions("status", "status",
                                                            "id_status", "name_status"); ?> </td>
                                                    <td><?php echo isFieldRequired("new_keyboard.php", "status"); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Asignado a usuario:</td>
                                                    <td><?php echo generateSelectWithOptions("id_user_asigned", "user",
                                                            "id_user", "email"); ?> </td>
                                                    <td><?php echo isFieldRequired("new_keyboard.php", "id_user_asigned"); ?></td>
                                                </tr>
                                                
                                                <tr>
                                                    <td>Marca:</td>
                                                    <td><input type="text" size="50" name="trademark" value="<?php echo $trademark;?>"> </td>
                                                    <td><?php echo isFieldRequired("new_keyboard.php", "trademark"); ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Modelo:</td>
                                                    <td><input type="text" size="50" name="model" value="<?php echo $model;?>"/></td>
                                                    <td><?php echo isFieldRequired("new_keyboard.php", "model"); ?></td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><?php echo isFieldRequired("new_keyboard.php", "conector"); ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                   ...
                                                   <td><textarea  name="description"><?php echo $description;?></textarea></td>
                                                    ...
                                                    <td><input type="submit" class="normalButton" name="saveKeyboard" value="Guardar datos"/> </td>
                                                    <td></td><td></td><td></td>
